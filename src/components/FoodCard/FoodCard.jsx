...
const FoodCard = ({isFavorite, foodName, foodType, foodImg, foodPrice}) => {
  return (
    <div className='w-[380px] h-[140px] bg-white flex flex-row relative rounded-xl drop-shadow-md hover:scale-105 p-4 hover:drop-shadow-xl'>
        <div className='flex flex-col gap-2'>
            ...
            <h2 className='font-bold text-xl h-3/6 content-center'>{foodName}</h2>
            <div className='flex flex-row gap-8 justify-center items-center'>
                ...
                <div className='flex flex-row gap-1 justify-center items-center'>
                    ...
                    <p className='text-[#5A5C62] text-[16px] font-semibold'>4.5</p>
                    <div className='bg-[#2A6E4F] ml-2 text-white text-[11px] w-[25px] h-[25px] flex justify-center items-center rounded-md'>
                    <FaCartShopping />
                    </div>
                </div>
            </div>
        ...
        <div className='flex w-full justify-end items-end pr-2 text-xl'>
            <FaHeart className={isFavorite ? 'text-[#FF7A28]' : 'text-[#D9D9D9]'}/>
        </div>
    </div>
  )
}
